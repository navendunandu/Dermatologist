...
if(isset($_POST["btn_update"]))
 {
	...
	$up="update tbl_seller set seller_name='".$na."', seller_contact='".$con."', seller_email='".$em."', seller_address='".$add."' where seller_id=".$_SESSION['sid'];
	if($conn->query($up))
	{
		?>
		<script>
...
<form id="form1" name="form1" method="post" action="">
  <table border="1" cellpadding="10" style="border-collapse:collapse">
    ...
    <tr>
      ...
      <input type="text" name="txt_contact" id="txt_contact" value="<?php echo $contact;?>" required="required"/></td>
    </tr>
    <tr>
      <td>Email</td>
    ...
    <tr>
      ...
      <input type="text" name="txt_address" id="txt_address" value="<?php echo $address;?>" required="required"/></td>
    </tr>
    <tr>
