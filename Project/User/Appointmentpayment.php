...
{
	$ins="update tbl_appointment set appointment_status=3 where appointment_id=".$_GET['bid'];
	$conn->query($ins);
	?>
    <script>
...
<body>
	...
	<div class="wrapper">
		...
		<form method="POST">
            ...
            <div class="input-group">
				<div class="input-box">
					<input class="name" type="tel" id="txtrate" name="txtrate"  value="Rs.150" readonly>
