...
$selqry="select * from tbl_cart c inner join tbl_booking b on b.booking_id=c.booking_id inner join tbl_newuser u on u.user_id=b.user_id inner join tbl_product p on p.product_id=c.product_id inner join tbl_seller k on k.seller_id=p.seller_id where c.cart_id='".$_GET["id"]."'";
        ...
        <table style="width: 100%; table-layout: fixed">
          <tr>
            ...
            >
              ...
              >
              	<span
                style="color:#F93;font-size:56px">Near2Perfection</span>
      ...
      >
        ...
        <tbody>
          <tr>
            ...
            <td><img src="../Assets/Files/Product/<?php echo $data["product_photo"];?>" width="119" height="92" /></td>
