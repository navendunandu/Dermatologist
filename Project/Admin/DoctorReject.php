...
<?php
$i=0;
$selQuery="select * from tbl_doctor n inner join tbl_place p on n.place_id=p.place_id inner join tbl_district d on d.district_id=p.district_id where doctor_status=2";
...
if($result->num_rows>0)
{
  ...
  while($data=$result->fetch_assoc())
  {
    ...
    <td><a href="DoctorList.php?rid=<?php echo $data['doctor_id']?>">Accept</a></td> 
  </tr>
  <?php
  }
 ?>
