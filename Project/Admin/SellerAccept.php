...
$conn->query($reject);
header("location:SellerAccept.php");	
}
...
<?php
$i=0;
$selQuery="select * from tbl_seller n inner join tbl_place p on n.place_id=p.place_id inner join tbl_district d on d.district_id=p.district_id where seller_status=1";
