...
if(isset($_POST['btn_submit']))
{
	...
	{
		$ins_query="insert into tbl_seller(seller_name,seller_contact,seller_email,seller_address,place_id,seller_photo,seller_password,seller_proof,seller_doj)values('$name','$contact','$email','$address','$place','$photo','$password','$proof',curdate())";
	//echo $ins_query;
